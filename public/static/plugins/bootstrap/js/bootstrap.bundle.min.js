...
!(function (t, e) {
    ...
    Rn = (function () {
      ...
      return (
        ...
        (t.setContent = function () {
          ...
          this.setElementContent(p(t.querySelectorAll(kn)), this.getTitle()),
            p(t).removeClass(On + " " + Nn);
        }),
        ...
        (i._jQueryInterface = function (n) {
          return this.each(function () {
            ...
            if (
              ...
              (t || ((t = new i(this, e)), p(this).data(vn, t)),
              "string" == typeof n)
            ) {
              if ("undefined" == typeof t[n])
                throw new TypeError('No method named "' + n + '"');
      ...
      return (
        ...
        (i._jQueryInterface = function (n) {
          return this.each(function () {
            ...
            if (
              (t || !/dispose|hide/.test(n)) &&
              (t || ((t = new i(this, e)), p(this).data(Mn, t)),
              "string" == typeof n)
            ) {
              if ("undefined" == typeof t[n])
                throw new TypeError('No method named "' + n + '"');
    ...
    _i = (function () {
      ...
      return (
        ...
        (t._getConfig = function (t) {
          if (
            "string" !=
            typeof (t = l({}, ni, "object" == typeof t && t ? t : {})).target
          ) {
            var e = p(t.target).attr("id");
            e || ((e = m.getUID(Zn)), p(t.target).attr("id", e)),
              (t.target = "#" + e);
          }
        ...
        (t._activate = function (e) {
          ...
          n.hasClass(ri)
            ? (n.closest(fi).find(pi).addClass(si), n.addClass(si))
            : (n.addClass(si),
              n
                .parents(li)
                .prev(ci + ", " + ui)
                .addClass(si),
              n.parents(li).prev(hi).children(ci).addClass(si)),
  ...
  p(window).on(oi.LOAD_DATA_API, function () {
    for (
      var t = [].slice.call(document.querySelectorAll(ai)), e = t.length;
      e--;
        ...
        (i._jQueryInterface = function (n) {
          return this.each(function () {
            var t = p(this),
              e = t.data(vi);
            if (
              (e || ((e = new i(this)), t.data(vi, e)), "string" == typeof n)
            ) {
  ...
  var Hi = "toast",
    ...
    Vi = (function () {
      ...
      return (
        (t.show = function () {
          var t = this;
          p(this._element).trigger(Mi.SHOW),
            this._config.animation && this._element.classList.add(Wi);
          var e = function () {
        ...
        (i._jQueryInterface = function (n) {
          return this.each(function () {
            ...
            if (
              (e ||
                ((e = new i(this, "object" == typeof n && n)), t.data(ji, e)),
              "string" == typeof n)
            ) {
              if ("undefined" == typeof e[n])
                throw new TypeError('No method named "' + n + '"');
